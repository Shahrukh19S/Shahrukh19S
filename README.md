...
- **[ollama-mcp-chat-cli](https://github.com/Shahrukh19S/ollama-mcp-chat-cli):** terminal MCP chat agent
  on local Ollama, with Groq/GitHub fallbacks.
- **[ollama-litellm-tool-calling](https://github.com/Shahrukh19S/ollama-litellm-tool-calling):** fully
  local LLM tool-calling via litellm.
- **[multi-provider-resume-extractor](https://github.com/Shahrukh19S/multi-provider-resume-extractor):**
  typed multi-provider LLM client for schema-validated structured extraction from messy resume PDFs.

## Tech and tools
Python · PyTorch · TensorFlow · scikit-learn · LangChain · LangGraph · MCP · RAG · Vector DBs · Ollama · Docker

## Currently
Building production agentic AI ("governed autonomy") for financial services, deepening my ML and
deep-learning foundations, and building in public.
